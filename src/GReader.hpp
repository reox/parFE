  ...
  */
  template<typename T> int Read(const std::string& name, T& scalar) { Seek(name); return Read(scalar); }
   ...
   /*! A block will correspond to a line in the ASCII file.
    ...
    \return Number of records read.
  */
  template<typename T> int Read(const std::string& name, T* vec, int num_global_elems, int num_my_elems, int elem_size, int my_offset);
    ...
    \return Number of records read.
    */
    template<typename T> int Read(const std::string& name, T* vec, int num_elems, int elem_size) {
  ...
  /*! A block will correspond to a line in the ASCII file. Each block consists of two subblocks of different types.
    ...
    \return number of records read.
  */
  template<typename T1, typename T2> int Read(const std::string& name, const std::string&, T1* vec1, const std::string&, T2* vec2, int num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int my_offset);
  ...
  /*! A block will correspond to a line in the ASCII file. Each block consists of two subblocks of different types.
    ...
    \return number of records read.
  */
    template<typename T1, typename T2> int Read(const std::string& name, const std::string& name1, T1* vec1, const std::string& name2, T2* vec2, int num_elems, int elem_size1, int elem_size2) {
...
//! Generic function to read a block multityped vector.
  /*! A block will correspond to a line in the ASCII file. Each block consists of three subblocks of different types.
    ...
    \return Number of records read.
  */
  template<typename T1, typename T2, typename T3> int Read(const std::string& name, const std::string&, T1* vec1, const std::string&, T2* vec2,const std::string&, T3* vec3, int num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int elem_size3, int my_offset);
...
//! Generic function to read an entire block multityped vector.
  /*! A block will correspond to a line in the ASCII file. Each block consists of three subblocks of different types.
    ...
    \return Number of records read.
  */
    template<typename T1, typename T2, typename T3> int Read(const std::string& name, const std::string& name1, T1* vec1, const std::string& name2, T2* vec2, const std::string& name3, T3* vec3, int num_elems, int elem_size1, int elem_size2, int elem_size3){
...
class CPP_ASCII_GReader
{
  ...
  */
  ...
  /*! A block will correspond to a line in the ASCII file. Each block consists of two subblocks of different types.
    ...
    \return Number of records read.
  */
  template<typename T1, typename T2> int Read(const std::string& name, const std::string& name1, T1* vec1, const std::string& name2, T2* vec2, int num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int my_offset);
  ...
  */
  ...
  /*! A block will correspond to a line in the ASCII file. Each block consists of three subblocks of different types.
    ...
    \return Number of records read.
  */
  template<typename T1, typename T2, typename T3> int Read(const std::string&, const std::string&, T1* vec1, const std::string&, T2* vec2,const std::string&, T3* vec3, int num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int elem_size3, int my_offset);
...
class HDF5_GReader
{
  ...
  */
  ...
  /*! A block will correspond to a row of a compound dataset. Each block consists of three subblocks of different types.
    ...
    \return Number of records read.
  */
  template<typename T1, typename T2, typename T3> int Read(const std::string& name, const std::string& name1, T1* vec1, const std::string& name2, T2* vec2,const std::string& name3, T3* vec3, int num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int elem_size3, int my_offset);
...
private:
  ...
  int Read(const std::string& name, hid_t type, void* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset);
  int Read(const std::string& name, hid_t type, void* data);
  void copy(void* dest, const void* src, int nblocks, int block_size, int stride);
  std::string filename;
  hid_t file;
  hid_t group;
  hid_t plist;
...
template<typename T> 
int C_ASCII_GReader::Read(const std::string& name, T* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset)
{
  Seek(name);
  T value;
  int k=0;
			 ...
			 int my_offset)
{
  ...
  int i;
  for (i=0; i< my_offset; ++i) {
    for (int j=0; j < elem_size1; ++j)
      Read(value1);
    for (int j=0; j < elem_size2; ++j)
      Read(value2);
  }
...
template<typename T> 
int CPP_ASCII_GReader::Read(const std::string& name, T* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset)
{
  Seek(name);
  T value;
  int k=0;
...
template<typename T>
int HDF5_GReader::Read(const std::string& name, T* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset)
{
  T dummy = 0;
...
template<typename T>
int HDF5_GReader::Read(const std::string& name, T* data, int num_elems, int elem_size)
{
    int res;
    if (mpi_rank == 0)
			 ...
			 int my_offset)
{
  ...
  int nbytes1 = elem_size1*sizeof(T1);
  int nbytes2 = elem_size2*sizeof(T2);
  int stride = nbytes1+nbytes2;
			 ...
			 int my_offset)
{
  ...
  int nbytes1 = elem_size1*sizeof(T1);
  int nbytes2 = elem_size2*sizeof(T2);
  int nbytes3 = elem_size3*sizeof(T3);
  int stride = nbytes1+nbytes2+nbytes3;
  void* data = malloc(num_my_elems*(stride));
