...
class C_ASCII_GWriter
{
  ...
  */
  ...
  /*! A block will correspond to a line in the ASCII file.
    ...
    \return number of records written.
  */
  template<typename T> int Write(const std::string& name, const T* vec, int num_global_elems, int num_my_elems, int elem_size, int my_offset);
  ...
  /*! A block will correspond to a line in the ASCII file. Each block consists of two subblocks of different types.
    ...
    \return number of records written.
  */
  template<typename T1, typename T2> int Write(const std::string& name, const std::string& name1, const T1* vec1, const std::string& name2, const T2* vec2, int num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int my_offset);
  ...
  /*! A block will correspond to a line in the ASCII file. Each block consists of three subblocks of different types.
    ...
    \return number of records written.
  */
  template<typename T1, typename T2, typename T3> int Write(const std::string& name, const std::string& name1, const T1* vec1, const std::string& name2, const T2* vec2,const std::string& name3, const T3* vec3, int  num_global_elems, int num_my_elems, int elem_size1, int elem_size2, int elem_size3, int my_offset);
...
class HDF5_GWriter
{
  ...
  */
  ...
  /*! The block vector will be mapped into a dataspace of rank two.
    ...
    \return Number of records written.
  */
  template<typename T> int Write(const std::string& name, const T* vec, int num_global_elems, int num_my_elem, int elem_size1, int my_offset);
  ...
  /*! A block will correspond to a row in a compound dataset. Each block consists of two subblocks of different types.
    ...
    \return Number of records written.
  */
  template<typename T1, typename T2> int Write(const std::string&, const std::string&, const T1*, const std::string&, const T2*, int num_global_elems, int num_my_elem, int elem_size1, int elem_size2, int my_offset);
  ...
  /*! A block will correspond to a row of a compound dataset. Each block consists of three subblocks of different types.
    ...
    \return Number of records written.
  */
  template<typename T1, typename T2, typename T3> int Write(const std::string&, const std::string&, const T1*, const std::string&, const T2*,const std::string&, const T3*, int num_global_elems, int num_my_elem, int elem_size1, int elem_size2, int elem_size3, int my_offset);
...
private:
  ...
  int Write(const std::string& name, hid_t type, const void* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset);
...
template<typename T>
int CPP_ASCII_GWriter::Write(const std::string& name, const T* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset)
{
  int i=0;
#ifdef HAVE_MPI
  MPI_Status status;
...
template<typename T>
int C_ASCII_GWriter::Write(const std::string& name, const T* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset)
{
  int i=0;
#ifdef HAVE_MPI
  MPI_Status status;
...
template<typename T>
int HDF5_GWriter::Write(const std::string& name, const T* data, int num_global_elems, int num_my_elems, int elem_size, int my_offset)
{
  T dummy = 0;
			 ...
			 int my_offset)
{
  ...
  int res = Write(name, s_tid, data, num_global_elems, num_my_elems, 1, my_offset);
  free(data);
  return res;
}
